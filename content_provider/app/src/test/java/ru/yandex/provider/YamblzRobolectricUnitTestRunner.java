...
public class YamblzRobolectricUnitTestRunner extends RobolectricGradleTestRunner {
    ...
    public Config getConfig(@NonNull Method method) {
        ...
        return new Config.Implementation(
                ...
                UnitTestProviderApp.class, // Notice that we override real application class for Unit tests.
    ...
    @NonNull
    public static ProviderApp yamblzApp() {
        return (ProviderApp) RuntimeEnvironment.application;
    }
}
