...
public abstract class BaseFragment extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        mainThreadHandler = ProviderApp.get(context).applicationComponent().mainThreadHandler();
    }
    ...
    public void onDestroy() {
        ProviderApp.get(getContext()).applicationComponent().leakCanaryProxy().watch(this);
        super.onDestroy();
    }
}
